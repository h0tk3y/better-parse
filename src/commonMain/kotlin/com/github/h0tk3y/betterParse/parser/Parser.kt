...
public abstract class Parsed<out T> : ParseResult<T>() {
    ...
    public override fun toString(): String = "Parsed($value)"
...
public abstract class ErrorResult : ParseResult<Nothing>() {
    public override fun toString(): String = "ErrorResult"
}
...
public class ParseException(@Suppress("CanBeParameter") public val errorResult: ErrorResult) : Exception("Could not parse input: $errorResult")
